...
/* criminals */
sh_int	 gsn_rage;
sh_int	 gsn_sithsorcery;
sh_int	 gsn_forcemind;
sh_int	 gsn_callforce;
sh_int	 gsn_force_defense;
sh_int	 gsn_fear;
sh_int	 gsn_enhance_senses;
sh_int	 gsn_enhance_ability;
sh_int	 gsn_battlemind;
sh_int   gsn_torture;
...
sh_int                  gsn_hodin;
sh_int                  gsn_huttese;
sh_int                  gsn_iktotchese;
sh_int			gsn_jawa;
sh_int                  gsn_keldor;
sh_int			gsn_lekku;
sh_int                  gsn_miralukese;
sh_int			gsn_mon_calamarian;
sh_int                  gsn_muun;
sh_int                  gsn_noghri;
sh_int                  gsn_rodese;
sh_int                  gsn_ryn;
sh_int                  gsn_shyriiwook;
sh_int                  gsn_skytric;
sh_int			gsn_sriluurian;
sh_int                  gsn_sullustese;
sh_int                  gsn_togorian;
sh_int                  gsn_togruti;
sh_int                  gsn_ubese;
sh_int                  gsn_umbarese;
...
void boot_db( bool fCopyOver )
{
	...
	ASSIGN_GSN( gsn_cerean,		"cerean" );
	ASSIGN_GSN( gsn_chagri,		"chagri" );
	ASSIGN_GSN( gsn_dashadi,	"dashadi" );
	ASSIGN_GSN( gsn_defel,	 	"defel" );
	ASSIGN_GSN( gsn_dosh,		"dosh" );
	ASSIGN_GSN( gsn_drallish,	"drallish" );
	ASSIGN_GSN( gsn_falleen,	"falleen" );
	ASSIGN_GSN( gsn_hodin,	 	"ho'din" );
	ASSIGN_GSN( gsn_huttese,	"huttese" );
	ASSIGN_GSN( gsn_iktotchese,	"iktotchese" );
	ASSIGN_GSN( gsn_jawa,		"jawa" );
	ASSIGN_GSN( gsn_keldor,		"kel dor" );
	ASSIGN_GSN( gsn_miralukese,	"miralukese" );
	ASSIGN_GSN( gsn_mon_calamarian,	"mon calamarian" );
	ASSIGN_GSN( gsn_muun,		"muun" );
	ASSIGN_GSN( gsn_noghri,		"noghri" );
	ASSIGN_GSN( gsn_rodese,		"rodese" );
        ASSIGN_GSN( gsn_ryn,	        "ryn" );
        ASSIGN_GSN( gsn_shyriiwook,     "shyriiwook" );
        ASSIGN_GSN( gsn_skytric,    	"skytric" );
        ASSIGN_GSN( gsn_sriluurian,     "sriluurian" );
	ASSIGN_GSN( gsn_sullustese,	"sullustes" );
	ASSIGN_GSN( gsn_togorian,	"togorian" );
	ASSIGN_GSN( gsn_togruti,	"togruti" );
	ASSIGN_GSN( gsn_ubese,		"ubese" );
	ASSIGN_GSN( gsn_umbarese,	"umbaran" );
	ASSIGN_GSN( gsn_verpine,	"verpine" );
        ASSIGN_GSN( gsn_lekku,		"lekku" );
	...
	ASSIGN_GSN( gsn_callforce, "call force");
	ASSIGN_GSN( gsn_force_defense, "force defense");
	ASSIGN_GSN( gsn_fear, "fear");
	ASSIGN_GSN( gsn_enhance_senses, "enhance senses");
	ASSIGN_GSN( gsn_enhance_ability, "enhance ability");
	ASSIGN_GSN( gsn_battlemind, "battlemind" );
	ASSIGN_GSN( gsn_sithsorcery, "sith sorcery" );
	ASSIGN_GSN( gsn_forcemind, "force mind" );
    }
...
void load_resets( AREA_DATA *tarea, FILE *fp )
{
	...
	case 'M':
	    if ( get_mob_index( arg1 ) == NULL && fBootDb && arg1 < arg3)
	...
	case 'O':
	    if ( get_obj_index(arg1) == NULL && fBootDb && arg1 < arg3)
	...
	case 'R':
	    pRoomIndex = get_room_index( arg1 );
	    if ( !pRoomIndex && fBootDb && arg1 < arg3)
